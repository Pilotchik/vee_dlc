...
<div id="main">
	...
	<ul class="breadcrumb">
		<li class="active">Управление презентациями</li>
	</ul>
	...
	<h3  style="margin-top:20px;">Презентации</h3>
	<div class="row">
	<?php
	if (count($presents) > 0)
	{
					...
					<div class="panel-collapse collapse in"> 
						...
						<ul class="list-group">
							...
							<li class="list-group-item" style="text-align:right;">
								<div class="btn-group">
									<a href="<?= base_url() ?>present_admin/slides_view/<?= $key['id'] ?>" class="btn btn-info">Просмотр слайдов</a>
