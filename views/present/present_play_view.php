<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		...
		<script>
			...
			{
				console.log("Timer");
				$.post ('<?= base_url() ?>present/get_indexes',{present_id:<?= $present_id ?>},function(data,status){
				...
				else
				{
					...
					else
					{
						...
						index_v = obj.index_v;
						console.log(obj);
						if (index_h != prev_index_h || index_v != prev_index_v)
						{
							Reveal.slide(index_h,index_v);
							prev_index_v = index_v;
							prev_index_h = index_h;
						}
					}
				}
				})
				setTimeout("processTimer()",5000);
			}
