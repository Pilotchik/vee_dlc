...
class vkapi {
  ...
  var $app_id;
	...
	function api($method,$params=false,$app_id,$sig) {
		if (!$params) $params = array(); 
		$params['api_id'] = $app_id;
		//$params['v'] = '5.21';
		$params['client_secret'] = 'LXGYFTULRHhxoYQ5vExI';
		...
		$res = Send_Post('https://api.vk.com/method/users.get',$this->params($params),'http://vk.com/app'.$this->app_id.'_'.$this->app_id);
